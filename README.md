...
|---|---|---|---|
| NexGuard Connect (macOS) | `0.5.10` | `0.0.5` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
| NexGuard Connect (Windows) | `0.6.2` | `0.1.0` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
| NexGuard Connect (Linux CLI) | `0.3.2` | `0.1.7` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
| NexGuard Server | `4.0.6` | `3.0.0` | [NexGuard](https://github.com/0xphuong/NexGuard) |
