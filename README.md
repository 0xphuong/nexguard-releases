...
|---|---|---|---|
| NexGuard Connect (macOS) | `0.5.3` | `0.0.5` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
| NexGuard Connect (Windows) | `0.5.0` | `0.1.0` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
