...
|---|---|---|---|
| NexGuard Connect (macOS) | `0.1.0` | `0.0.5` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
| NexGuard Connect (Windows) | `0.2.0` | `0.1.0` | [nexguard-connect](https://github.com/0xphuong/nexguard-connect) |
